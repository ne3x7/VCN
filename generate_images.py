...
def main():
    ...
    cv2.imwrite('%s/%s/%s.png' % (args.outdir, "generated", "mask"), 255*flowl0[:, :, -1])
    cv2.imwrite('%s/%s/%s.png' % (args.outdir, "generated", "img1"), 255*iml0[:, :, ::-1])
    cv2.imwrite('%s/%s/%s.png' % (args.outdir, "generated", "img2"), 255*iml1[:, :, ::-1])
